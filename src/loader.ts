...
export async function loadPage(url: string, max_age_secs: number = (60 * 60 * 24 * 7), ua: string = edgeUa) {
    ...
    if (max_age_secs != 0) {
        ...
        console.log("retrieved %d bytes from %s", response.data.length, url);
    }
